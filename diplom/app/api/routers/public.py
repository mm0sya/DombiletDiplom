...
async def submit_contact(
    ...
    try:
        ...
        message["From"] = "foot_bilet@mail.ru"  # замените на ваш email
        message["To"] = email
        message["Subject"] = "Ваша заявка получена"
        message.set_content(f"Здравствуйте, {name}! Ваша заявка успешно отправлена.\n\nСкоро менеджер свяжется с вами и ответит на все ваши вопросы.")
