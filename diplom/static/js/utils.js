...
function renderCart(matches) {
    ...
    if (cart.length === 0) {
        cartContainer.innerHTML = '<p class="text-gray-500">К сожалению, ваша корзина пуста.</br> Но вы можете вернуться к <a href="/matches" class="text-blue-500 underline hover:text-blue-700">выбору билетов.</a></p>';
...
async function submitCheckout(matches) {
    ...
    const fanId = form.querySelector('#fan_id').value;
